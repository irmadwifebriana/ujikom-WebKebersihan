                       ...
                       @csrf
							...
							<div class="col-md-6">
                                    ...
                                    <h5>Bagian<span class="text-danger">*</span></h5>
                                        <select class="form-control select2" style="width: 100;" name="id_bagian" id="id_bagian">
                                            <option disable value>Pilih Bagian<option>
						...
						<div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="nama_petugas" value="{{$editData->nama}} class="form-control" required data-validation-required-message="This field is required"> </div>
                            </div>
                        </div>
